...
cm_v1
# geralmente acima de 70 % ja est� ficando bom...
...
library(DMwR)
?SMOTE #algoritmo para classes desbalanceadas
# criando registros sinteticos para reamostragem...
# Aplicando o SMOTE - SMOTE: Synthetic Minority Over-sampling Technique
# https://arxiv.org/pdf/1106.1813.pdf

table(dados_treino$inadimplente)
prop.table(table(dados_treino$inadimplente))
set.seed(9560)  # processo randomico
...
# Construindo a terceira versao do modelo apenas com as variaveis mais importantes
## "+" pra concatenar e nao ponto(selecionaria todos)
...
#pra comparar os outros modelos: 
cm_v2
cm_v1

# Calculando Precision, Recall e F1-Score, metricas de avaliacaoo do modelo preditivo
y <- dados_teste$inadimplente
...
#ara erro pos os dados eram numericos...
...
# O que vimos aqui foi apenas uma breve demonstracao do que � Machine Learning.
# Para aprender como construir e aplicar modelos de Machine Learning em diferentes
#problemas de nega�ao confira os demais cursos em nosso portal:
